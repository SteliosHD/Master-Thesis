...
class SyntheticData:
    ...
    def __init__(self, n_length_tasks, m_length_workers, popular_ratio=0.18, json_path='', seed=2021):
        ...
        self.popular_tasks, self.non_popular_tasks = self.generate_popular_tasks(self.popular_ratio)
    ...
    def generate_popular_tasks(self, popular_ratio):
        popular_tasks = set()
        ...
        return popular_tasks, non_popular_tasks
    ...
    def create_worker_tasks(self, popular_ratio=None, distribution=None):
        """
        ...
        if distribution is None:
            ...
            for worker in self.workers:
                ...
                num_popular_tasks = math.ceil(popular_ratio * num_tasks)
                num_non_popular_tasks = num_tasks - num_popular_tasks
    ...
    def create_synthetic_data(self, valuations_range, number_of_tasks_range, costs_range=None):
        ...
        self.create_worker_tasks(popular_ratio=0.25, distribution=self.worker_tasks_distribution)
...
if __name__ == "__main__":
    synth_data = SyntheticData(50, 100)
    costs_range = (1, 25)
    ...
    synth_data.dataframe_to_csv(tasks_df, 'tasks',
                                path='/Users/hdrop/Documents/Personal FIles/master-thesis-experiments/data/data_files/')
    synth_data.dataframe_to_csv(worker_df, 'workers',
                                path='/Users/hdrop/Documents/Personal FIles/master-thesis-experiments/data/data_files/')
    synth_data_2 = SyntheticData(20, 20)
    ...
    synth_data.dataframe_to_csv(tasks_df_2, 'tasks_2',
                                path='/Users/hdrop/Documents/Personal FIles/master-thesis-experiments/data/data_files/')
    synth_data.dataframe_to_csv(worker_df_2, 'workers_2',
                                path='/Users/hdrop/Documents/Personal FIles/master-thesis-experiments/data/data_files/')
    synth_data_3 = SyntheticData(20, 20)
