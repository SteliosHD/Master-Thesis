...
logging.basicConfig(level=logging.DEBUG, format='%(asctime)s %(levelname)-8s %(message)s',
                    ...
                    filename='/Users/hdrop/Documents/Personal FIles/master-thesis-experiments/config/logs/log{}.log'.format(
                        time_date),
                    filemode='w')
...
if __name__ == '__main__':
    main(suffix='_2', set_upper=False)
    # create_synth_data(10,10,'/Users/hdrop/Documents/Personal FIles/master-thesis-experiments/data/data_files/test_dir','Discrete_Normal', "tasks_discrete","workers_discrete")
    # create_synth_data(20,10,'/Users/hdrop/Documents/Personal FIles/master-thesis-experiments/data/data_files/test_dir','Augmentened_Discrete_Normal', "tasks_discrete_aug","workers_discrete_aug")
    # create_synth_data(20,20,'/Users/hdrop/Documents/Personal FIles/master-thesis-experiments/data/data_files/test_dir','Uniform', "tasks_uniform","workers_uniform")
