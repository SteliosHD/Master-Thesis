...
worker_df = reader.read_data_csv2df(file_path=
                                    "/Users/hdrop/Documents/Personal FIles/master-thesis-experiments/related_work/data_x/freelancer/freelancer_user_df.csv")
task_df = reader.read_data_csv2df(file_path=
                                  "/Users/hdrop/Documents/Personal FIles/master-thesis-experiments/related_work/data_x/freelancer/freelancer_skill_df.csv")
...
def add_valuation(task_df, upper_bound, std, rare, common, seed=1, lower_bound=1):
    ...
    for task in task_list:
        if task in rare:
            ...
            val_list.append(np.random.uniform(lower_bound, max(1, upper_bound - std / 4)))
