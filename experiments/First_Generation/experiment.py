...
class Experiment:
    ...
    def run_instances(self, algorithm, file_paths, exec_uid):
        ...
        return dataset_results, dataset_results_data, dataset_optimal_results, len(workers)
    ...
    def run_experiments(self, file_suffix='', project='synthetic', result_suffix='', override_params=(),algorithm_param=()):
        ...
        for algorithm in algorithms:
            for dataset_key in dataset_keys:
                ...
                results, data_results, optimal_results, n_worker_len = self.run_instances(algorithm, self.file_paths,
                                                                                          exec_uid=exec_id)
                ...
                excel_data = self.prepare_excel_data(results, optimal_results, n_worker_len, dataset_key)
    ...
    def prepare_excel_data(self, results, optimal_results, n_worker_len, dataset_key):
